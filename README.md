...
`@12ui/design` release revision. Version **0.2.42** matches the npm package.
...
Each GitHub release attaches `12ui-design-0.2.42.zip`, a validated
...
`design-v0.2.42`, and published only after the matching npm release
