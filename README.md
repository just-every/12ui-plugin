...
`@12ui/design` release revision. Version **0.2.37** matches the npm package.
...
Each GitHub release attaches `12ui-design-0.2.37.zip`, a validated
...
`design-v0.2.37`, and published only after the matching npm release
